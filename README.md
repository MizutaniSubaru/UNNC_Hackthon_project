...
6. OCR-based image text extraction for planning inputs.
7. PDF courseware to markdown notes workflow (beta).
8. Calendar export utilities and quote rotation UX elements.
...
5. 提供 created/updated/completed/deleted 活动历史。
6. 支持图片 OCR 识别作为输入来源。
7. 支持课件 PDF 转 Markdown 学习笔记（Beta）。
8. 提供日历导出能力与语录轮播等体验功能。
